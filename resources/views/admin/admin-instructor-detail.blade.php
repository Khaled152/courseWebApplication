				...
				<div class="card bg-transparent border rounded-3 h-100">
					...
					<div class="card-body">
						...
						<div class="avatar avatar-xl mb-3">
							<img class="avatar-img rounded-circle border border-white border-3 shadow" src="images/avatar/07.jpg" alt="">
						</div>
								...
								<tbody>
									...
									<tr>
										...
										<td class="d-flex align-items-center position-relative">
											<div class="w-60px"><img src="images/courses/4by3/08.jpg" class="rounded" alt=""></div>
									...
									<tr>
										<!-- Table data -->
										<td class="d-flex align-items-center position-relative">
											<div class="w-60px"><img src="images/courses/4by3/02.jpg" class="rounded" alt=""></div>
									...
									<tr>
										<!-- Table data -->
										<td class="d-flex align-items-center position-relative">
											<div class="w-60px"><img src="images/courses/4by3/04.jpg" class="rounded" alt=""></div>
									...
									<tr>
										<!-- Table data -->
										<td class="d-flex align-items-center position-relative">
											<div class="w-60px"><img src="images/courses/4by3/07.jpg" class="rounded" alt=""></div>
									...
									<tr>
										<!-- Table data -->
										<td class="d-flex align-items-center position-relative">
											<div class="w-60px"><img src="images/courses/4by3/10.jpg" class="rounded" alt=""></div>
