										...
										<form class="row text-start g-3">
											...
											<div class="col-12">
												...
												<div class="position-relative">
													...
													<img src="images/client/visa.svg" class="w-40px position-absolute top-50 end-0 translate-middle-y me-2 d-none d-sm-block" alt="">
												</div>
											</div>
											<!-- Expiration Date -->
											<div class="col-md-6">
							...
							<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<!-- Payment method item -->
										<td><img src="images/client/mastercard.svg" class="h-40px" alt=""><span class="ms-2">****4568</span></td>
									...
									<tr>
										...
										<!-- Payment method item -->
										<td><img src="images/client/mastercard.svg" class="h-40px" alt=""><span class="ms-2">****2588</span></td>
									...
									<tr>
										...
										<!-- Payment method item -->
										<td><img src="images/client/paypal.svg" class="w-80px" alt=""></td>
				...
				<form class="row text-start g-3">
					...
					<div class="col-12">
						...
						<div class="position-relative">
							...
							<img src="images/client/visa.svg" class="w-40px position-absolute top-50 end-0 translate-middle-y me-2" alt="">
						</div>
					</div>
					<!-- Expiration Date -->
					<div class="col-md-6">
