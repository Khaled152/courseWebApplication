...
<!-- Mirrored from eduport.webestica.com/student-quiz.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Mar 2023 01:34:15 GMT -->
<head>
	...
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-4 text-center text-md-start mb-3 mb-md-0">
				<!-- Logo START -->
				<a href="index.html"> <img class="h-20px" src="images/logo-light.svg" alt="logo"> </a>
			</div>
