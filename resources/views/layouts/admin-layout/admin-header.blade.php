...
<body>
                    ...
                    <ul class="navbar-nav flex-column" id="navbar-sidebar">
                        ...
                        <li class="nav-item section-head">
                            ...
                            <ul class="nav collapse flex-column" id="courses" data-bs-parent="#navbar-sidebar">
                                <li class="nav-item  "> <a class="nav-link" id="admin-courses-href"
                                        href="{{ route('admin-courses') }}">All Courses</a></li>
                                <li class="nav-item"> <a class="nav-link" id="admin-courses-categories-href"
                                        href="{{ route('admin-courses-categories') }}">Course Category</a></li>
                        ...
                        <!-- Menu item 3 -->
                        <li class="nav-item"> <a class="nav-link" id="admin-students"
                                href="{{ route('admin-students') }}"><i
                                    class="fas fa-user-graduate fa-fw me-2"></i>Students</a></li>

                        <!-- Menu item 4 -->
                        <li class="nav-item">
                            <a class="nav-link" id="admin-instructors" data-bs-toggle="collapse" href="#instructors"
                                role="button" aria-expanded="false" aria-controls="instructors">
                                <i class="fas fa-user-tie fa-fw me-2"></i>Instructors
                            </a>
                            <!-- Submenu -->
                            <ul class="nav collapse flex-column" id="instructors" data-bs-parent="#navbar-sidebar">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('admin-instructors') }}"
                                        id="admin-instructors-href">Instructors</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="admin-instructor-detail.html">Instructor
                                        Detail</a></li>
                                <li class="nav-item">
                                    <a class="nav-link" id="admin-instructors-requests-href"
                                        href="{{ route('admin-instructors-requests') }}">Instructor requests
    ...
    <script>
        ...
        console.log(`${pramas[2]}-${pramas[3]}`)
        let targetLink = document.getElementById(`${pramas[2]}${pramas.length > 3 ? `-${pramas[3]}` : ""}`)
